"""
This is a revised python class to control driving and collection hardware, based on the Milestone 1 drive class
"""
...
class Hardware_Control:
    ...
    def __init__(self):
        ...
        # Added assignment of collection and deposition pins
        self.stepL = 18
        self.stepR = 19
        self.dirL = 23
        self.dirR = 24
        ...
        self.pi.set_mode(self.act_retract, pigpio.OUTPUT)
        self.pi.set_mode(self.act_extend, pigpio.OUTPUT)

        self.pi.set_mode(self.tach, pigpio.INPUT)
        self.pi.set_mode(self.limit_sw, pigpio.INPUT)
    ...
    def shake(self, count=1):
        ...
        for count in range(count):
            ...
            time.sleep(0.1)
            self.execute_drive(movement_time, -0.01, -1*right_wheel_speed)
            time.sleep(0.1)
